...
export declare class RecommendationsController {
    ...
    getStats(rigId?: number): Promise<{
        total: number;
        byPriority: (import(".prisma/client").Prisma.PickEnumerable<import(".prisma/client").Prisma.RcmRecommendationGroupByOutputType, "priority"[]> & {
            _count: {
                id: number;
            };
        })[];
        byStatus: (import(".prisma/client").Prisma.PickEnumerable<import(".prisma/client").Prisma.RcmRecommendationGroupByOutputType, "status"[]> & {
            _count: {
                id: number;
            };
        })[];
