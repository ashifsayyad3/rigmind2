...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List certificates with expiry filters' }),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CertificatesController.prototype, "getExpiryDashboard", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get certificate detail with attachments' }),
...
exports.CertificatesController = CertificatesController = __decorate([
    ...
    (0, common_1.Controller)({ path: 'certificates', version: '1' }),
