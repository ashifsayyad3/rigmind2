...
;
;
const API = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL ?? 'http://localhost:4000/api/v1';
const token = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('rigmind_token') : ("TURBOPACK unreachable", undefined);
const authHeader = {
    headers: {
...
function AdminPage() {
    ...
    const { data: usersData, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "AdminPage.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API}/auth/users`, authHeader).then({
...
//# sourceMappingURL=apps_web_src_app_dashboard_admin_page_tsx_81fec09e._.js.map